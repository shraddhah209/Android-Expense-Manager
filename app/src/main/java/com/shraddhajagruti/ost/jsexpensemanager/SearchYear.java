...
public class SearchYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SearchYear.this , Search.class);
    ...
    private void openAndQueryDatabase() {
        ...
        try {
            ...
            Cursor c = newDB.rawQuery("SELECT amount, category,date FROM expense where date like '%"+strDatey+"%'", null);
